...
export default function NavigationMenu() {
  ...
  return (
    <nav className="bg-[#040873] shadow-md p-4 fixed top-0 left-0 w-full z-50">
      <div className="container mx-auto flex items-center justify-between">
        <Link href="/" className="text-2xl font-bold text-white">WadeFord</Link>
        ...
        <ul className="hidden md:flex space-x-6">
          ...
          <li><Link href="/students" className="px-3 py-5 text-white rounded hover:bg-[#ded605] transition-colors duration-300">Our Offers</Link></li>
          ...
          <li><Link href="/contact" className="px-3 py-5 text-white rounded hover:bg-[#ded605] transition-colors duration-300">Contact</Link></li>
        </ul>
      </div>
      ...
      {isOpen && (
        <ul className="md:hidden mt-2 space-y-2 text-center bg-white shadow-md p-4">
          ...
          <li><Link href="/students" className="block py-2 hover:bg-[#ded605] transition-colors duration-300" onClick={() => setIsOpen(false)}>Our Offers</Link></li>
          ...
          <li><Link href="/contact" className="block py-2 hover:bg-[#ded605] transition-colors duration-300" onClick={() => setIsOpen(false)}>Contact</Link></li>
        </ul>
      )}
    </nav>
  );
